...
const projects = [
  {
    title: 'FinGuard',
    description:
      'A personal finance management app that uses ML for financial forecasting, simulation and analysis.',
    image: '/finguard.png',
  ...
  },
  {
    title: 'Harbinger',
    description:
      'A third-party API degradation detection engine that identifies incidents before vendors acknowledge them. Analyzes response time distributions, error rates, and timeout patterns to compute a real-time degradation confidence score — alerting teams ahead of status page updates.',
    image: '/harbinger.png',
    tech: [
      'Node.js',
      'Fastify',
    ...
    link: 'https://github.com/BlazeGaming456/harbinger'
  },
  {
